...
public class DLights {
     ...
     *
     * @param port The I2CPort that the dLights are attached to.
     */
     ...
     *
     * @param lightNo The sequence number of the dLight (1-4). Please note that the group number 0 is invalid for this method.
     ...
     *
     * @param lightNo The sequence number of the dLight (0-4).
     */
     ...
     * @return True, the dLight is enabled. False, the dLight is off.
     */
     ...
     *
     * @param lightNo The sequence number of the dLight (0-4).
     * @param rgb     an integer array containing RGB colors
     */
     ...
     *
     * @param hue        The hue value in the range of 0-360
     * @param saturation The saturation value in the range of 0-100
     * @param luminosity The saturation luminosity value in the range of 0-100
     */
     ...
     *
     * @param lightNo      The sequence number of the dLight (0-4).
     * @param seconds      The total time of a blinking cycle (in seconds)
     * @param percentageOn The percentage of the time the LED is on within a blinking cycle
     */
     ...
     *
     * @param lightNo (1-4). Please note that the group number 0 is invalid for this method.
     * @return True, blinking is enabled. False, blinking is disabled.
     */
     ...
     *
     * @param lightNo The sequence number of the dLight (1-4). Please note that the group number 0 is invalid for this method.
     * @param rgb     the RGB color of the LED
     */
     ...
     *
     * @param lightNo The sequence number of the dLight (0-4).
     * @param value   The values should be between 0 (fully off) and 255 (fully on).
     */
    ...
    private class LED extends I2CSensor implements DLight {
        ...
        public Future<ExceptionWrapper> disable() {
            return setRegister(MODE1, MODE1MASK + SLEEPMODE);
        }

        public Future<ExceptionWrapper> enable() {
            return setRegister(MODE1, MODE1MASK);
        }
         ...
         * @param v
         */
        private Future<ExceptionWrapper> setRegister(int n, int v) {
            buf[0] = (byte) v;
            return sendDataAsync(n, buf, 1);
        }

        public Future<ExceptionWrapper> setColor(int r, int g, int b) {
            buf[0] = (byte) (r % 256);
            buf[1] = (byte) (g % 256);
            buf[2] = (byte) (b % 256);
            return sendDataAsync(COLOR + AUTOINCREMENT, buf, 3);
        }
        ...
        public Future<ExceptionWrapper> setHSLColor(int hue, int saturation, int luminosity) {
            ...
            return setColor((int) (r * 255), (int) (g * 255), (int) (b * 255));
        }

        public Future<ExceptionWrapper> setExternalLED(int w) {
            buf[0] = (byte) (w);
            return sendDataAsync(EXTERNAL, buf, 1);
        }
        ...
        public Future<ExceptionWrapper> disableBlinking() {
            return setRegister(LEDOUT, BLINKINGOFF);
        }
