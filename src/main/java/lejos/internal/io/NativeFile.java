...
public class NativeFile {
     ...
     * @throws FileNotFoundException
     */
    public synchronized void open(String fname, int flags, int mode) throws FileNotFoundException {
     ...
     */
    public synchronized int ioctl(int req, byte[] buf) {
     ...
     * @return Linux style ioctl return
     */
    public synchronized int ioctl(int req, Pointer buf) {
        return clib.ioctl(fd, req, buf);
    }
